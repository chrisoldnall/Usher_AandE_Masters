...
create_choropleth_scenario(
  ...
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottishAttendanceRate2022.svg"
)
...
create_choropleth_scenario(
  ...
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottish4Hour2022.svg"
)
...
create_choropleth_scenario(
  ...
  year = 2020,
  scenario = "attendance",
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottishAttendanceRate2020.svg"
)
...
create_choropleth_scenario(
  ...
  year = 2020,
  scenario = "waiting_time",
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottish4Hour2020.svg"
)
...
create_choropleth_scenario(
  ...
  year = 2018,
  scenario = "attendance",
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottishAttendanceRate2018.svg"
)
...
create_choropleth_scenario(
  ...
  year = 2018,
  scenario = "waiting_time",
  output_path = "coldnall/results/COVID_Choloropleths/Updated/CovidScottish4Hour2018.svg"
)
```
...
ggsave("CovidScottish_WaitingAttendance_2018_2020_2022.svg", plot = grid_plot, width = 45, height = 30, device = "svg")
ggsave("CovidScottish_WaitingAttendance_2018_2020_2022.png", plot = grid_plot, width = 45, height = 30, device = "png")
```